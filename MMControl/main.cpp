...
case IDOK:
	...
	if(c==0){MessageBox(hDlg,L"Нужно ввести правильное шестнадцатеричное число с префиксом 0х, или выбрать предопределенное значение",0,MB_OK|MB_ICONWARNING);break;}
...
case IDCANCEL:fStopFlag=true;hProgressDlg=NULL;EndDialog(hDlg,0);break;
}break;
